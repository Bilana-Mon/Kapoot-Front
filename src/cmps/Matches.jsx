...
function Matches() {
    return (
        <section>
            <div className="flex items-center text-gray-800 w-full border-b border-slate-500 pb-5">
                <span>
                    <SpineIcon className="w-[40px] h-[40px] top-0" />
                </span>{' '}
                <span>Match History</span>{' '}
            </div>
            <div className="text-gray-800 w-full border-b border-slate-500 pb-5 pt-5">
